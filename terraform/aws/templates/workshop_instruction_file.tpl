...
3. Next, go to the following website - ${WEBAPP_URL} and click **Create a Database** at the source database and give ```<name>_<random6char>``` Make note of this name.<br>
...
1. Go to the website: ${WEBAPP_URL}
...
1. Click on the link - ${WEBAPP_URL}
...
10. Once done, click continue and wait for the sink connector to get provisioned. View the status as running in the connectors page.
 ...
 ## <a name="step-8"></a>**Observe Real-time data streaming to destination database**
  ...
  1. Go to the site - ${WEBAPP_URL} and click **Refresh Records**. This will reflect all the previously added records in the source database reflecting on the target database as well.
