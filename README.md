...
3. Next, go to the following website - 34.245.97.107:3000 and click **Create a Database** at the source database and give ```<name>_<random6char>``` Make note of this name.<br>
...
4. Come back to connectors page and click next. Enter the database details as provided in the workshop.
    1. Database hostname: rds1-src-2150.cfbfhdyr6yyd.eu-west-1.rds.amazonaws.com
...
1. Go to the website: 34.245.97.107:3000
...
1. Click on the link - 34.245.97.107:3000
...
4. Next, in the database connection details, enter database details as provided in the workshop.
    1. Database hostname: rds2-dst-2150.cfbfhdyr6yyd.eu-west-1.rds.amazonaws.com
    2. Database port: 5432
    3. Database username: postgres
    4. Database password: password
...
10. Once done, click continue and wait for the sink connector to get provisioned. View the status as running in the connectors page.
 ...
 ## <a name="step-8"></a>**Observe Real-time data streaming to destination database**
  ...
  1. Go to the site - 34.245.97.107:3000 and click **Refresh Records**. This will reflect all the previously added records in the source database reflecting on the target database as well.
